<?php
    if (isset($_POST['submit'])) {
        ...
        /*  If we allow the above line then this will be the result.
            ...
            Array ( [name] => rebmug.png [type] => image/png [tmp_name] => F:\xampp\tmp\phpCEA4.tmp [error] => 0 [size] => 283511 )
        ...
        if(in_array($fileActualExt, $fileExt)) // We will check whether the extension of the uploaded file matches our allowed list.
        {
            ...
            if($fileError === 0)
            {
                ...
                if($fileSize < 10000000)
                {
                    ...
                    $fileNewName = uniqid('', true).".".$fileActualExt; // We will be using time format and please note if don't mention actual extenstion then file will be saved as rebmug not rebmug.png.
